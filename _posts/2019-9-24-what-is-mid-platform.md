...
还有一种推理帝们的说法是，后台对应了面向内部人员的运营配置、前台对应了面向用户的客户端，所以中台就是衔接它两的。我想说别忘了，这是压根不懂技术的高层提出来的，当年张建锋接到马老师的中台作业，也纳闷了半天，百思不得其解。高层管理们不会这么理性的技术化的看待前中后台的关系，我猜测他们的逻辑是，用户看得到的这些叫前台，这之后看不见的所有的支撑平台叫后台，由于考虑到需要直接支撑前台，所以搞了一个前无古人，后无来者的叫法——中台，连专业代码二十年的阿里各大技术元老们都涨了见识。要我看，这所谓的中台本质上还是通用型后端+后台，网上也不乏此类理解者。通用业务能力是后端服务，基于能力做编排则需要通过后台系统来实现。

说了这么多，总结下本文通用的中台定义：前台的支撑系统，后台中直接支撑前台的那部分，由可以复用的业务领域能力和与其对应的后台系统共同组成。画成图的话大概是这样：
...
玩过或懂魔兽争霸的同学怕是已经张口喊出了“卧槽”。所以说，单说游戏工厂这种产品或游戏创作模式，暴雪的游戏团队绝对是全球顶尖的。在超级细胞的官网介绍中也曾提到，他们的很多员工都是魔兽世界的铁粉[6]。然而人们关注的往往是成功的对象，暴雪最近几年在手游领域除了炉石传说这种卡牌类的，几乎没出啥游戏。PC游戏做的再好，知名度也很难与全民参与度更高的手游相比。与这些先驱游戏公司类似的，超级细胞的“中台”系统本质也是一个游戏工厂，是游戏行业里的一种高复用性、高度可自定义、高度开放式设计的软件系统。当然了，我相信这个工厂生产的东西只是一套虚拟的游戏逻辑，具体的用户端APP还是需要依靠研发团队进一步加工和研发的。
...
> 中台由中台能力组成，具体表现为一个个领域系统，叫不叫中台不重要，重要的是这个领域的服务能力是通用的。其实非技术人眼里的中台，就是技术人员眼里的后台，没啥区别。
